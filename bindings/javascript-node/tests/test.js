...
assert(!IGS.serviceHasReplies("myServiceWithReplies"));
assert(!IGS.serviceHasReply("myServiceWithReplies", "toto"));
assert(IGS.serviceReplyNames("myServiceWithReplies").length === 0);
assert(IGS.serviceReplyArgsList("myServiceWithReplies", "toto").length === 0);
assert(IGS.serviceReplyArgsCount("myServiceWithReplies", "toto") === 0);
...
assert(IGS.serviceHasReplies("myServiceWithReplies"));
assert(IGS.serviceHasReply("myServiceWithReplies", "myReply"));
...
assert(IGS.serviceReplyArgExists("myServiceWithReplies", "myReply", "myString"));
assert(IGS.serviceReplyArgExists("myServiceWithReplies", "myReply", "myData"));
assert(IGS.serviceReplyArgExists("myServiceWithReplies", "myReply2", "myBool2"));
assert(IGS.serviceReplyArgExists("myServiceWithReplies", "myReply2", "myInt2"));
assert(IGS.serviceReplyArgExists("myServiceWithReplies", "myReply2", "myDouble2"));
assert(IGS.serviceReplyArgExists("myServiceWithReplies", "myReply2", "myString2"));
assert(IGS.serviceReplyArgExists("myServiceWithReplies", "myReply2", "myData2"));
assert(IGS.serviceReplyArgRemove("myServiceWithReplies", "myReply", "myBool") === igsResultEnum.IGS_SUCCESS);
assert(IGS.serviceReplyArgRemove("myServiceWithReplies", "myReply", "myInt") === igsResultEnum.IGS_SUCCESS);
assert(IGS.serviceReplyArgRemove("myServiceWithReplies", "myReply", "myDouble") === igsResultEnum.IGS_SUCCESS);
assert(IGS.serviceReplyArgRemove("myServiceWithReplies", "myReply", "myString") === igsResultEnum.IGS_SUCCESS);
assert(IGS.serviceReplyArgRemove("myServiceWithReplies", "myReply", "myData") === igsResultEnum.IGS_SUCCESS);
assert(IGS.serviceReplyArgRemove("myServiceWithReplies", "myReply", "myBool") === igsResultEnum.IGS_FAILURE);
assert(IGS.serviceReplyArgRemove("myServiceWithReplies", "myReply", "myInt") === igsResultEnum.IGS_FAILURE);
assert(IGS.serviceReplyArgRemove("myServiceWithReplies", "myReply", "myDouble") === igsResultEnum.IGS_FAILURE);
assert(IGS.serviceReplyArgRemove("myServiceWithReplies", "myReply", "myString") === igsResultEnum.IGS_FAILURE);
assert(IGS.serviceReplyArgRemove("myServiceWithReplies", "myReply", "myData") === igsResultEnum.IGS_FAILURE);
assert(!IGS.serviceReplyArgExists("myServiceWithReplies", "myReply", "myBool"));
assert(!IGS.serviceReplyArgExists("myServiceWithReplies", "myReply", "myInt"));
assert(!IGS.serviceReplyArgExists("myServiceWithReplies", "myReply", "myDouble"));
assert(!IGS.serviceReplyArgExists("myServiceWithReplies", "myReply", "myString"));
...
assert(IGS.serviceReplyArgsCount("myServiceWithReplies", "myReply") === 0);
assert(IGS.serviceReplyArgsList("myServiceWithReplies", "myReply").length === 0);
assert(IGS.serviceReplyRemove("myServiceWithReplies", "myReply") === igsResultEnum.IGS_SUCCESS);
assert(IGS.serviceReplyRemove("myServiceWithReplies", "myReply") === igsResultEnum.IGS_FAILURE);
assert(!IGS.serviceHasReply("myServiceWithReplies", "myReply"));
names = IGS.serviceReplyNames("myServiceWithReplies");
assert((names.length === 1) && (names[0] === "myReply2"));

assert(IGS.serviceReplyArgRemove("myServiceWithReplies", "myReply2", "myBool2") === igsResultEnum.IGS_SUCCESS);
assert(IGS.serviceReplyArgRemove("myServiceWithReplies", "myReply2", "myInt2") === igsResultEnum.IGS_SUCCESS);
assert(IGS.serviceReplyArgRemove("myServiceWithReplies", "myReply2", "myDouble2") === igsResultEnum.IGS_SUCCESS);
assert(IGS.serviceReplyArgRemove("myServiceWithReplies", "myReply2", "myString2") === igsResultEnum.IGS_SUCCESS);
assert(IGS.serviceReplyArgRemove("myServiceWithReplies", "myReply2", "myData2") === igsResultEnum.IGS_SUCCESS);
assert(IGS.serviceReplyArgRemove("myServiceWithReplies", "myReply2", "myBool2") === igsResultEnum.IGS_FAILURE);
assert(IGS.serviceReplyArgRemove("myServiceWithReplies", "myReply2", "myInt2") === igsResultEnum.IGS_FAILURE);
assert(IGS.serviceReplyArgRemove("myServiceWithReplies", "myReply2", "myDouble2") === igsResultEnum.IGS_FAILURE);
assert(IGS.serviceReplyArgRemove("myServiceWithReplies", "myReply2", "myString2") === igsResultEnum.IGS_FAILURE);
assert(IGS.serviceReplyArgRemove("myServiceWithReplies", "myReply2", "myData2") === igsResultEnum.IGS_FAILURE);
assert(!IGS.serviceReplyArgExists("myServiceWithReplies", "myReply2", "myBool2"));
assert(!IGS.serviceReplyArgExists("myServiceWithReplies", "myReply2", "myInt2"));
assert(!IGS.serviceReplyArgExists("myServiceWithReplies", "myReply2", "myDouble2"));
assert(!IGS.serviceReplyArgExists("myServiceWithReplies", "myReply2", "myString2"));
assert(!IGS.serviceReplyArgExists("myServiceWithReplies", "myReply2", "myData2"));
assert(IGS.serviceReplyArgsCount("myServiceWithReplies", "myReply2") === 0);
assert(IGS.serviceReplyArgsList("myServiceWithReplies", "myReply2").length === 0);
assert(IGS.serviceHasReply("myServiceWithReplies", "myReply2"));
assert(IGS.serviceReplyRemove("myServiceWithReplies", "myReply2") === igsResultEnum.IGS_SUCCESS);
assert(IGS.serviceReplyRemove("myServiceWithReplies", "myReply2") === igsResultEnum.IGS_FAILURE);
assert(!IGS.serviceHasReply("myServiceWithReplies", "myReply2"));
names = IGS.serviceReplyNames("myServiceWithReplies");
